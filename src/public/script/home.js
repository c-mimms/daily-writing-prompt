...
//variable containing a list of writing prompt ideas for creative writing
...
const daysSince = Math.floor((new Date() - new Date("December 6, 2023")) / (1000 * 60 * 60 * 24))

const todaysPrompt = promptArray[daysSince % promptArray.length]

//set the innerHTML of the h2 element to the prompt
document.getElementById("todaysPrompt").innerHTML = todaysPrompt
